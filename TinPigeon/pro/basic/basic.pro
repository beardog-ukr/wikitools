...
HEADERS += ../../src/basic/cpp/ActionReplaceEditor.h
HEADERS += ../../src/basic/cpp/ActionSetPageContent.h
...
SOURCES += ../../src/basic/cpp/ActionReplaceEditor.cpp
SOURCES += ../../src/basic/cpp/ActionSetPageContent.cpp
